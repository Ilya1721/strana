...
export default class FooterFinanceArticle extends Component {
    constructor(props) {
      super(props);
      this.state = {
        items: []
...
if (document.getElementById('footerFinanceArticle')) {
    ReactDOM.render(<FooterFinanceArticle />, document.getElementById('footerFinanceArticle'));
}

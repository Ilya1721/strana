...
export default class RightBarPrivate extends Component {
    constructor(props) {
      super(props);
      this.state = {
        items: []
...
if (document.getElementById('rightBarPrivate')) {
    ReactDOM.render(<RightBarPrivate />, document.getElementById('rightBarPrivate'));
}
